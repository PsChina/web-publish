...
echo ""
echo "下一步:"
echo "  1. (推荐, default) 跑 web-publish setup 配 cookie 一次:"
echo "       web-publish setup"
echo "     之后所有发文章走 urllib backend, 简单可靠, 不依赖 Chrome 在跑."
echo ""
echo "  2. (可选) 如果想用 opencli-bridge backend (零 cookie 配置, 但依赖 Chrome+extension):"
echo "     在 Chrome 里 Load unpacked → $EXT_DIR"
echo "     opencli doctor && web-publish health juejin --backend opencli-bridge"
echo ""
echo "  3. 验证: web-publish health juejin"
echo ""
